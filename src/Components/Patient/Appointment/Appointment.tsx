...
import { cancelAppointment, getAppointmentByPatientId, scheduleAppointment } from '../../../Service/AppointmentService.tsx';
...
const Appointment=()=> {
    ...
    const fetchData=()=>{
       getAppointmentByPatientId(user.profileId).then((data)=>{
    ...
    const leftToolbarTemplate=()=>{
       return <Button leftSection={<IconPlus/>} onClick={open} variant='filled'> Schedule Appointment</Button>
